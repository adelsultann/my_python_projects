...
def display_logo(url, row, column):
    img = Image.open(url)
    # img.size[0] = height
    # img.size[1] = width of the picture
    # is the size of the original picture we do this method to resize the picture
...
def display_images(img):
    # calling the resize function to resize each image before displaying it
